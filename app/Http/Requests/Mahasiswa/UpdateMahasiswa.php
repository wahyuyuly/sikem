...
class UpdateMahasiswa extends FormRequest
{
    ...
    {
        return [
            'npm' => 'required|max:255|unique:mahasiswa,id,'.$this->id,
            'nama' => 'required',
            ...
            'sd.nilai' => 'nullable',
            'sd.ijazah' => 'nullable|mimes:pdf|max:3000',

            'smp.nama' => 'required',
            'smp.tahun_masuk' => 'required|numeric',
            'smp.tahun_lulus' => 'required|numeric',
            'smp.nilai' => 'nullable',
            'smp.ijazah' => 'nullable|mimes:pdf|max:3000',
            ...
            'sma.nilai' => 'nullable',
            'sma.ijazah' => 'nullable|mimes:pdf|max:3000',
