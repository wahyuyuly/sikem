                            ...
                            {!! Form::open(['url'=> route('login')]) !!}
                                <div class="form-group {{ $errors->has('username') || $errors->has('email') ? 'has-error' : '' }}">
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('login', null, ['required', 'class'=> $errors->has('username') || $errors->has('email') ? 'form-control is-invalid' : 'form-control', 'placeholder'=>'Alamat Email / NIM']) !!}
                                    </div>
                                </div>
                                <div class="form-group password-field {{ $errors->has('password') ? 'has-error' : '' }}">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                        ...
                                        {!! Form::password('password', ['required', 'class'=> $errors->has('password') ? 'form-control is-invalid' : 'form-control', 'placeholder'=>'Kata sandi']) !!}
                                ...
                                <div class="mt-10">
                                    Belum punya akun? <a href="{{ route('regist') }}">Daftar di sini</a>
                                </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
