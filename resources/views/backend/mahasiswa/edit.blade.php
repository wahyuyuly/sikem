            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        {!! Form::model($data, ['route'=>['mahasiswa.update', $data->id], 'files'=>'true', 'method'=>'put']) !!}
                        <div class="card-body">
                            @alert
                            @endalert
                        ...
                        <div class="card-footer text-right">                            
                            <a href="{{ Auth::user()->hasRole(['mahasiswa']) ? route('home') : route('mahasiswa.index') }}"><button type="button" class="btn btn-danger btn-icon icon-left"><i class="fas fa-undo-alt"></i> Batal</button></a>
