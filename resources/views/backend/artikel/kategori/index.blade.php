            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body"> 
                            <div class="mb-4">
                                <a href="{{ route('kategori.create') }}"><button class="btn btn-md btn-warning btn-icon icon-left"><i class="fas fa-plus"></i> Tambah Kategori</button></a>
                            </div>                       
