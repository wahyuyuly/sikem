            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body"> 
                            <div class="mb-4">
                                <a href="{{ route('artikel.create') }}"><button class="btn btn-md btn-warning btn-icon icon-left"><i class="fas fa-plus"></i> Tulis Artikel</button></a>
                            </div>                       
