        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">                                        
                    {!! Form::label('title', 'Judul Artikel', ['class'=>'control-label']) !!}                                        
                    {!! Form::text('title', null, ['placeholder'=>'Judul artikel...', 'class'=>$errors->has('title') ? 'form-control is-invalid' : 'form-control']) !!}
