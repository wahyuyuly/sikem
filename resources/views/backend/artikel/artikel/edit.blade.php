        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    {!! Form::model($data, ['route'=>['artikel.update', $data->id], 'method'=>'put', 'files'=>true]) !!}
                    <div class="card-body">
                        @alert
                        @endalert
                        @include('backend.artikel.artikel._form')                  
                    </div>
                    <div class="card-footer text-right">                            
                        <a href="{{ route('artikel.index') }}"><button type="button" class="btn btn-danger btn-icon icon-left"><i class="fas fa-undo-alt"></i> Batal</button></a>
...
@section('scripts')
    ...
    @include('backend.artikel.artikel._js')
@endsection