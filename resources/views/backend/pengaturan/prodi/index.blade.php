                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Master Program Studi</h4>                            
                        </div>
                        <div class="card-body"> 
                            <div class="mb-4">
                                <a href="{{ route('master-prodi.create') }}"><button class="btn btn-md btn-warning btn-icon icon-left"><i class="fas fa-plus"></i> Tambah Program Studi</button></a>
                            </div>                       
