                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Riwayat Pendidikan Non-Formal</h4> 
                        </div>
                        <div class="card-body">
                            @alert
                            @endalert
                            ...
                            {!! Form::close() !!}
                            @endrole
                            <a href="#" id="tambah-data" class="mb-3 btn btn-sm btn-primary btn-icon icon-left {{ Auth::user()->hasRole(['mahasiswa']) ? '' : 'disabled' }}" type="button"><i class="fas fa-plus"></i> Tambah Riwayat Pendidikan Non-Formal</a>
...
@section('scripts')
    ...
    <script>
        ...
        var dataList = $('#dataList').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '{{ route("pendidikan-non-formal.index") }}',
                data: function(d) {
                    d.data = mahasiswa_id
                }              
            },
        ...
        $(document).ready(function() { 
            ...
            $('#tambah-data').on('click', function(e) {
                ...
                var ret = '{{ route("pendidikan-non-formal.create", ":id") }}';
    ...
    @delete
        {{ route('pendidikan-non-formal.destroy', ':id') }}
    @enddelete
@endsection