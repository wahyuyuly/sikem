                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Data Riwayat Keanggotaan UKM</h4> 
                        </div>
                        <div class="card-body">
                            @alert
                            @endalert
                            ...
                            {!! Form::close() !!}
                            @endrole
                            <a href="#" id="tambah-data" class="mb-3 btn btn-sm btn-primary btn-icon icon-left {{ Auth::user()->hasRole(['mahasiswa']) ? '' : 'disabled' }}" type="button"><i class="fas fa-plus"></i> Tambah Capaian</a>
    ...
    <script>
        ...
        $(document).ready(function() { 
            ...
            $('#tambah-data').on('click', function(e) {
                ...
                var ret = '{{ route("riwayat-ukm.create", ":id") }}';
